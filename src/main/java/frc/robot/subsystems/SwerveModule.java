...
public class SwerveModule {
  ...
  public SwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    ...
    // Factory reset so we get the motor controllers to a known state before configuring
    ...
    */
     ...
     * We want radians and radians per second to use with WPILib's swerve APIs.
    */
    m_drivingEncoder.setPositionConversionFactor(ModuleConstants.kDrivingEncoderPositionFactor);
    m_drivingEncoder.setVelocityConversionFactor(ModuleConstants.kDrivingEncoderVelocityFactor);
     ...
     * This will allow the PID controller to go through 0 to get to the setpoint.
     */
    m_turningPIDController.setPositionPIDWrappingEnabled(true);
    m_turningPIDController.setPositionPIDWrappingMinInput(ModuleConstants.kTurningEncoderPositionPIDMinInput);
    m_turningPIDController.setPositionPIDWrappingMaxInput(ModuleConstants.kTurningEncoderPositionPIDMinInput);
    ...
    // Save the motor controller configurations.
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    // Command driving and turning motor controllers towards their respective setpoints.
